 ...
 */
@WebServlet("/rest/taskManage/pauseVideoObjectTask")
public class RecogTaskStop extends BaseServlet {
	private static final long serialVersionUID = 1L;

	private static final Logger logger = Logger.getLogger(RecogTaskStop.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RecogTaskStop() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			pauseVideoObjectTask(serialnumber);
	...
	protected void pauseVideoObjectTask(String serialnumber) {
		SqlExecutor excutor = SqlExecutor.getInstance();
		excutor.addSql("update vsd_task set isvalid = 0, slaveip = '' where serialnumber = ?", serialnumber);
		excutor.commit();
	}
}
